        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-4">
            <Field>
              ...
              <FieldContent>
                <Input id="name" placeholder="Jane Doe" required className="rounded-xl h-12 border border-white/20" />
              </FieldContent>
            </Field>
            ...
            <Field>
              ...
              <FieldContent>
                <Input id="email" type="email" placeholder="jane@example.com" required className="rounded-xl h-12 border border-white/20" />
              </FieldContent>
            </Field>
            ...
            <Field>
              ...
              <FieldContent>
                <Input id="password" type="password" placeholder="••••••••" required className="rounded-xl h-12 border border-white/20" />
              </FieldContent>
            </Field>
          </div>

          <Button type="submit" className="w-full h-14 rounded-full text-lg font-semibold group">
            Create Account
